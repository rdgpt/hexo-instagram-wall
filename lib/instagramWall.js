  ...
  function render(media) {
    ...
    if (media && Array.isArray(media)) {
      ...
      media.forEach(function(m) {
        ...
        let altText = m.caption.text.substring(0, 20);
        ...
        wall.push('<img class="instagram-wall__media" alt="' + altText + '" src="' + imageObject.url + '" width="' + imageObject.width + '" height="' + imageObject.height + '">');
